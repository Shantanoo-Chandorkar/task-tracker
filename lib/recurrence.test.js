...
describe('computeNextOccurrence', () => {
    ...
    it('returns the next day for a daily rule', () => {
        expect(computeNextOccurrence({ freq: 'DAILY' })).toEqual(new Date('2026-01-02T12:00:00.000Z'));
    });

    it('honours the interval', () => {
        expect(computeNextOccurrence({ freq: 'DAILY', interval: 3 })).toEqual(new Date('2026-01-04T12:00:00.000Z'));
    });
    ...
    it('falls back to a daily rule for an unknown frequency', () => {
        expect(computeNextOccurrence({ freq: 'SOMETIMES' })).toEqual(new Date('2026-01-02T12:00:00.000Z'));
    });
