...
describe('rebalancePositions', () => {
    ...
    it('sorts unsorted input before renumbering', () => {
        ...
        expect(rebalancePositions(unsortedCollidingSiblings).map((sibling) => sibling.id)).toEqual([
            'a',
            'b',
            'c',
        ]);
    ...
    it('separates two siblings with identical positions', () => {
        ...
        const rebalancedPositions = rebalancePositions(duplicatePositionSiblings).map(
